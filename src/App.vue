    ...
    <v-main v-if="securityConsent">
      ...
      <v-banner lines="two" color="blue lighten-5" :stacked="false">
        <v-banner-text name="new-version">
          <span>
            Une nouvelle version de l'application va être déployée le jeudi 25 septembre à 17h, il est possible que Signaux Faibles ne soit pas accessible le vendredi 26 septembre toute la journée.
          </span>
        </v-banner-text>
      </v-banner>
