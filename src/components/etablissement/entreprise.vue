  ...
  <div>
    ...
    <div v-if="etablissementsSummary.length > 0">
      <v-layout align-center class="pt-3 pl-3" style="margin-bottom: 48px">
        ...
        <v-flex md5 shrink v-if="siegeEntreprise || etablissementsDepartement.length > 0 || autresEtablissements.length > 0"><v-btn style="text-transform: none;" outlined color="indigo" @click="toggle" class="ml-4">{{ show ? 'Masquer' : 'Afficher' }} les autres établissements</v-btn></v-flex>
      </v-layout>
